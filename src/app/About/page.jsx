  ...
  return (
    <motion.div className="h-full" initial={{ y: "-200vh" }} animate={{ y: "0%" }} transition={{ duration: 1 }}>
      <div className="h-full overflow-x-hidden scrollbar scrollbar-track-transparent scrollbar-thumb-mytheme lg:flex p-4 sm:px-8 md:px-12 lg:px-20 xl:px-40 gap-10">
        ...
        {/*IMAGE CONTAINER*/}
        <motion.div className="hidden overflow-hidden h-[640px] lg:flex items-center duration-200 justify-center w-2/5 sticky top-5 z-30" initial={{ y: -200, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.5, delay: 1, ease: "easeInOut" }}>
          {/* <AnimatedCover /> */}
