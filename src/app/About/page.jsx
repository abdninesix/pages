...
const AboutPage = () => {
  ...
  return (
    <motion.div className="h-full overflow-auto" initial={{y:"-200vh"}} animate={{y:"0%"}} transition={{duration:1}}>
      ...
      {/*BIO*/}
          <div className="flex flex-col gap-8 justify-center text-justify">
      ...
      {/*SKILLS*/}
          <div className="flex flex-col gap-12 justify-center" ref={skillRef}>
            ...
            <motion.div initial={{x:"-500px"}} animate={skillRefView ? {x:"0"} : {}} transition={{delay:0.2}} className="flex flex-wrap gap-4">
              <div className="p-2 rounded text-sm cursor-pointer bg-slate-800 text-white ">HTML5</div>
              <div className="p-2 rounded text-sm cursor-pointer bg-slate-800 text-white ">CSS3</div>
              <div className="p-2 rounded text-sm cursor-pointer bg-slate-800 text-white ">Javascript</div>
              <div className="p-2 rounded text-sm cursor-pointer bg-slate-800 text-white ">React.js</div>
              <div className="p-2 rounded text-sm cursor-pointer bg-slate-800 text-white ">Next.js</div>
              <div className="p-2 rounded text-sm cursor-pointer bg-slate-800 text-white ">TailwindCSS</div>
              <div className="p-2 rounded text-sm cursor-pointer bg-slate-800 text-white ">Framer-motion</div>
              <div className="p-2 rounded text-sm cursor-pointer bg-slate-800 text-white ">Figma</div>
            </motion.div>
            <Arrow/>
          </div>
        ...
        {/*LIST ITEM*/}       
              <div className="flex justify-between h-[320px] md:h-48">
                <div className="w-1/3 relative">
                  ...
                  <div className="text-sm font-semibold">2022-Present</div>
                  {/*<div className="p-3 bg-white text-sm font-semibold rounded-md text-center w-fit">No company</div>*/}
                </div>

                <div>
                  <div className="w-1 h-full md:-left-4 bg-black rounded relative">
                    <div className="absolute -left-2 w-5 h-5 rounded-full ring-4 ring-slate-500 bg-white"></div>
                  </div>
                </div>
        ...
        {/*LIST ITEM 2*/}
              <div className="flex justify-between h-[320px] md:h-48">
                ...
                <div className="w-1/3 relative">
                  ...
                  <div className="text-sm font-semibold">2021-2022</div>
                </div>
        ...
        {/*LIST ITEM 3*/}
              <div className="flex justify-between h-[320px] md:h-48">
                <div className="w-1/3 relative">
                  ...
                  <div className="text-sm font-semibold">2020-2021</div>
                </div>
