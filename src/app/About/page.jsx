    ...
    <motion.div className="h-full" initial={{y:"-200vh"}} animate={{y:"0%"}} transition={{duration:1}}>
      ...
      {/*SKILLS*/}
          <div className="flex flex-col gap-12 justify-center" ref={skillRef}>
            ...
            <motion.div initial={{x:"-500px"}} animate={skillRefView ? {x:"0"} : {}} transition={{delay:0.2}} className="flex flex-wrap gap-4">
              <div className="p-2 rounded text-sm bg-gray-800 dark:bg-gray-200 text-white dark:text-black">HTML5</div>
              <div className="p-2 rounded text-sm bg-gray-800 dark:bg-gray-200 text-white dark:text-black">CSS3</div>
              <div className="p-2 rounded text-sm bg-gray-800 dark:bg-gray-200 text-white dark:text-black">Javascript</div>
              <div className="p-2 rounded text-sm bg-gray-800 dark:bg-gray-200 text-white dark:text-black">React.js</div>
              <div className="p-2 rounded text-sm bg-gray-800 dark:bg-gray-200 text-white dark:text-black">Next.js</div>
              <div className="p-2 rounded text-sm bg-gray-800 dark:bg-gray-200 text-white dark:text-black">TailwindCSS</div>
              <div className="p-2 rounded text-sm bg-gray-800 dark:bg-gray-200 text-white dark:text-black">Framer-motion</div>
              <div className="p-2 rounded text-sm bg-gray-800 dark:bg-gray-200 text-white dark:text-black">Figma</div>
              <div className="p-2 rounded text-sm bg-gray-800 dark:bg-gray-200 text-white dark:text-black">Node.js</div>
              <div className="p-2 rounded text-sm bg-gray-800 dark:bg-gray-200 text-white dark:text-black">Expess.js</div>
              <div className="p-2 rounded text-sm bg-gray-800 dark:bg-gray-200 text-white dark:text-black">MongoDB</div>
            </motion.div>
            <Arrow/>
          </div>
      ...
      {/*EXPERIENCE*/}
        ...
        <div className="flex justify-between h-[320px] md:h-48">
                ...
                <div>
                  <div className="w-1 h-full md:-left-4 bg-gray-800 rounded relative">
                    <div className="absolute -left-2 w-5 h-5 rounded-full ring-4 ring-red-600 bg-white dark:bg-slate-700"></div>
                  </div>
                </div>

                <div className="w-1/3 relative">
                <div className="shadow-lg p-4 bg-white dark:bg-gray-950 font-semibold rounded-md text-center w-fit">Fullstack Web</div>
        ...
        <div className="flex justify-between h-[320px] md:h-48">
                <div className="w-1/3 relative">
                  <div className="shadow-lg p-4 bg-white dark:bg-gray-950 font-semibold rounded-md text-center w-fit">Frontend Web</div>
        ...
        {/*LIST ITEM 2*/}
              <div className="flex justify-between h-[320px] md:h-48">
                ...
                <div className="w-1/3 relative">
                  <div className="shadow-lg p-4 bg-white dark:bg-gray-950 font-semibold rounded-md text-center w-fit">Android Studio</div>
        ...
        {/*LIST ITEM 3*/}
              <div className="flex justify-between h-[320px] md:h-48">
                <div className="w-1/3 relative">
                  <div className="shadow-lg p-4 bg-white dark:bg-gray-950 font-semibold rounded-md text-center w-fit">Visual Studio</div>
