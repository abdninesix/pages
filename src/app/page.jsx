...
const Homepage = () => {
  return (
    ...
    <div className="overflow-auto items-center h-full flex flex-col gap-8 lg:flex-row px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48">

    {/*IMAGE CONTAINER*/}
    <motion.div className="flex h-[200px] w-[200px] md:h-[600px] md:w-1/2 mt-5" initial={{y:-200, opacity:0 }} animate={{ y:0, opacity:1 }} transition={{ duration: 0.5, delay:1, ease: "easeInOut" }}>
      <Image src="/hero.png" alt="hero" fill objectFit="cover" className="rounded-full ring-4 ring-red-600"/>
    </motion.div>
    ...
    <div className="h-auto lg:h-full lg:w-1/2 flex flex-col gap-5 justify-center text-center lg:text-left">
      ...
      <div className="flex gap-4 justify-start">
        <Link href="/Portfolio" className="bg-black hover:bg-red-600 text-white rounded-lg p-2">Check out my work</Link>
