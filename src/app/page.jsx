  ...
  return (
    ...
    <motion.div className="flex flex-col md:justify-center gap-4 md:gap-8 lg:gap-16 h-full overflow-hidden" initial={{ y: "-200vh" }} animate={{ y: "0%" }} transition={{ duration: 1 }}>
      ...
      <div className="items-center flex flex-col gap-4 md:gap-10 lg:flex-row px-4 sm:px-8 md:px-12 lg:px-20 xl:px-40">
        ...
        {/*IMAGE CONTAINER*/}
        <motion.div onContextMenu={handleRightClick} className="group relative flex-none overflow-hidden size-52 lg:size-80 bg-gradient-radial from-mytheme to-slate-800 rounded-full hover:rounded-t-full hover:rounded-b-none select-none duration-200" initial={{ x: -50, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ duration: 0.5, delay: 1, ease: "easeInOut" }}>
        ...
        <div className="h-auto lg:h-fit flex flex-col gap-5 lg:gap-6 justify-center text-center lg:text-left">
          ...
          <motion.div className="flex justify-center lg:justify-start gap-3 lg:gap-4" initial={{ y: -50, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.25, delay: 1.5, ease: "easeInOut" }}>
            <Link href="/About" className="bg-mytheme hover:bg-black dark:hover:bg-gray-200 dark:hover:text-black text-white rounded-md p-2">About me</Link>
            <Link href="/Portfolio" className="bg-mytheme hover:bg-black dark:hover:bg-gray-200 dark:hover:text-black text-white rounded-md p-2">My work</Link>
