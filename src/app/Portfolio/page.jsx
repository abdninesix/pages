    ...
    <motion.div className="h-full" initial={{y:"-200vh"}} animate={{y:"0%"}} transition={{duration:1}}>
      ...
      <div className="w-screen h-screen flex flex-col gap-16 items-center justify-center text-center bg-gray-300">
          ...
          <div className="relative">
            ...
            <Link href="/Contact" className="w-28 h-28 md:w-28 md:h-28 absolute top-0 left-0 right-0 bottom-0 m-auto bg-black ring-red-600 hover:ring-2 text-xl text-white rounded-full flex items-center justify-center">Hire me</Link>
          </div>
      </div>
