      ...
      <div className="h-[600vh] relative">
        ...
        <div className="sticky top-0 flex h-screen gap-4 items-center overflow-hidden">
          ...
          {items.map((item) => (
            ...
            <div className="h-screen w-screen flex items-center justify-center bg-gradient-to-r from-pink-300 to-slate-200"/>
          </motion.div>
        </div>

      </div>

      <div className="w-screen h-screen flex flex-col gap-16 items-center justify-center text-center bg-slate-200">
          ...
          <div className="relative">
            ...
            <Link href="/Contact" className="w-28 h-28 md:w-28 md:h-28 absolute top-0 left-0 right-0 bottom-0 m-auto bg-slate-700 hover:bg-black text-xl text-white rounded-full flex items-center justify-center">Hire me</Link>
          </div>
      </div>
