  ...
  return (
    <motion.div className="h-full scrollbar-none" initial={{y:"-200vh"}} animate={{y:"0%"}} transition={{duration:1}}>
      <div className="h-full overflow-hidden flex flex-col items-center justify-center gap-4 lg:gap-20 lg:flex-row pb-4 px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48">
        ...
        <motion.form onSubmit={sendEmail} ref={form} className="p-4 shadow-lg rounded-2xl h-fit w-[350px] md:w-1/2 lg:h-[550px] lg:mt-5 bg-gray-300 dark:bg-slate-900 text-lg flex flex-col gap-5 justify-center duration-200" initial={{opacity:0, y:50}} animate={{opacity:1, y:0}} transition={{delay:1, duration:0.25}}>
