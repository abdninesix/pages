...
const Behance = () => {
  return (
    <div>
        <svg className='w-fit h-fit' viewBox="1 2 21 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
const Github = () => {
  return (
    <div>
      <svg className='w-fit h-fit' viewBox="0 0 20 20" fill="currentColor">
...
const Freelancer = () => {
  return (
    <div>
      <svg viewBox="0 -15 85 80" xmlns="http://www.w3.org/2000/svg" className='w-fit h-fit' fill="currentColor"> <path d="M56.897 0l6.624 9.29L97.036 0M22.075 72.333l18.13-17.725-10.912-11.71M54.152 0l-9.69 8.738 16.298.608M16.482 0l3.48 7.133 19.18 1.195M26.75 36.986l14.17-26.434L-.23 8.328M28.4 38.662L41.785 53.04 56.55 38.567l4.582-26.957-17.993-.918"/> </svg>
    </div>
  )
}
...
const Upwork = () => {
  return (
    <div>
      <svg className='w-fit h-fit' viewBox="0 -2 32 32" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
...
const Linkedin = () => {
  return (
    <div>
      <svg className='w-fit h-fit' viewBox="-2 -1 23 23" fill="currentColor">
  ...
  return (
    <motion.div className="flex flex-row gap-2 justify-center md:justify-end w-fit rounded-lg" initial={{opacity:0}} animate={{opacity:1}} transition={{duration:0.3, delay:1.5}}>
          {profiles.map((profile, index) => (
            <Link key={index} className="h-10 w-10 p-1 text-gray-900 dark:text-gray-200 hover:scale-110 duration-200" href={profile.href}>
              {profile.icon}
            </Link> ))}
    </motion.div>
  )
