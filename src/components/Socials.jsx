...
const Behance = () => {
  return (
    <div>
        <svg className='w-fit h-fit' viewBox="0 0 22 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
const Github = () => {
  return (
    <div>
      <svg className='w-fit h-fit' viewBox="-1 -2 22 22" fill="currentColor">
...
const Upwork = () => {
  return (
    <div>
      <svg className='w-fit h-fit' viewBox="0 -3 32 32" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
