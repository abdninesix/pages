    ...
    <ThemeProvider>
      <AnimatePresence mode="wait">
        <div key={pathName} className="absolute top-0 z-[-2] h-screen w-screen bg-gray-200 dark:bg-slate-800 text-gray-800 dark:text-gray-200 duration-200">
          ...
          <motion.div animate={{ height: "0vh" }} exit={{ height: "140vh" }} transition={{ duration: 0.5, ease: easeOut }} className="h-screen w-screen fixed bg-slate-600 rounded-b-[100px] z-40" />
          ...
          <motion.div initial={{ height: "140vh" }} animate={{ height: "0vh", transition: { delay: 0.5 } }} className="h-screen w-screen fixed bg-slate-600 rounded-t-[100px] bottom-0 z-40" />
